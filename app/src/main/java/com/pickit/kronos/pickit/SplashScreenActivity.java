...
public class SplashScreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAirportSelectTextView = (AutoCompleteTextView) findViewById(R.id.splash_screen_airport_code);
        mStartButton = (Button) findViewById(R.id.splash_screen_start);
        mTerminalSelectSpinner = (Spinner) findViewById(R.id.splash_screen_terminal_select_spinner);
        ...
        mAirportSelectTextView.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long rowId) {
                ...
                ArrayList<String> terminalArrayList = new ArrayList<String>();
                ...
                //TODO:To Remove
                //mStartButton.setText(airportCode);
            }
        });
